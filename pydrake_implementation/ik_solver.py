...
class IKSolver:
  ...
  """
  def __init__ (self, urdf_file: Optional[str] = "allegro_assets/allegro_hand_description_right.urdf", 
                model_name: Optional[str] = "allegro_hand_right", 
                root_link_name: Optional[str] = "palm_link",
  ...
  def _print_EE_poses(self):
    """
    Prints out the end-effector poses.
    """     
    print("\nEnd-Effector Poses: ")
    for EE_frame_name in self._EE_frame_names:
